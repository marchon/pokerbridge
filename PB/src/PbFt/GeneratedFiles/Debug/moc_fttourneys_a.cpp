/****************************************************************************
** Meta object code from reading C++ file 'fttourneys_a.h'
**
...
#include "stdafx.h"
#include "..\..\fttourneys_a.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'fttourneys_a.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_FTTourneysAdaptor[] = {
    ...
    "onTourneyLobbyOpenedEvent(QString)\0"
};
...
int FTTourneysAdaptor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: observeTourney((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: onTourneyLobbyOpenedEvent((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
